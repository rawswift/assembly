...
startupcode
        ...
        jmp     loaded_
                ...
                right   db      'System Utility written by Ryan Yonzon '
                        db      '1998',0dh,0ah,0ah
...
return_em:
        ...
        int     21h
                ...
                _invalid_param_msg      db      'Invalid Parameter', 0dh, 0ah
...
done_exit:
        ...
        int     21h
                ...
                _creditz_msg db 'System Utility written by Ryan Yonzon',0dh,0ah
                             db 'Shareware Version 3.1 Copyright(C) 1998',0dh,0ah,0dh,0ah
                             db 'DISCLAIMER: The author does not take any responsability for any',0dh,0ah
                             db 'damage, either direct or implied, caused by the usage of this program',0dh,0ah
                             db 'No warrant is made about the product functionability or quality.',0dh,0ah,'$'
        ...
        d_o_s   endp
                ...
                oem_msg         db      'Original Equipment Manufacturer (OEM) identification is '
        ...
        bios_date       endp
                ...
                bios    db      'Basic Input/Output System (BIOS) Date is '
        ...
        printer         endp
                ...
                printer_detected_msg db 'Printer port detected'
